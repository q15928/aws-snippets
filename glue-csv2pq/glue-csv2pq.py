...
## @type: DataSource
## @args: [database = "datacatalog", table_name = "glueblog_raws3bucket_dkvfzg5qrvzo", transformation_ctx = "datasource0"]
## @return: datasource0
## @inputs: []
datasource0 = glueContext.create_dynamic_frame.from_catalog(database = "datacatalog", table_name = "glueblog_raws3bucket_dkvfzg5qrvzo", transformation_ctx = "datasource0")
## @type: ApplyMapping
...
## @type: DataSink
## @args: [connection_type = "s3", connection_options = {"path": "s3://glueblog-processeds3bucket-1t3vx40cr824"}, format = "parquet", transformation_ctx = "datasink4"]
## @return: datasink4
## @inputs: [frame = dropnullfields3]
datasink4 = glueContext.write_dynamic_frame.from_options(frame = dropnullfields3, connection_type = "s3", connection_options = {"path": "s3://glueblog-processeds3bucket-1t3vx40cr824"}, format = "parquet", transformation_ctx = "datasink4")
job.commit()